        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
			 ...
			 <input type="file" name="image" value="<?php echo $task ;?>" class="form-control" readonly />
			...
			if(isset($_POST["feedback"]))
			{
				...
				$sql = "UPDATE emp_monitoring SET status ='1',submit_date = '$date',file = '$file_name'  WHERE id = '$proid' ";	
